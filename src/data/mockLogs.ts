...
const rawMockEntries: LogEntry[] = [
  {
    ...
    level: 'CRITICAL',
    category: 'Biometrics',
    message: '2026-08-20 14:26:45 CRITICAL SQL injection attempt detected in visa passport lookup API payload endpoint=/api/v2/visa/verify-passport source_ip=185.220.101.44',
    statusCode: 403,
...
kubectl scale deployment/border-visa-gateway --replicas=16 -n egov-border`
  },
  {
    ...
    message: '2026-08-20 14:26:42 WARN Abnormal authentication rate spike detected for citizen login portal endpoint=/api/v1/auth/mfa-verify source_ip=194.26.29.112',
    statusCode: 429,
...
govlog-cli mfa enforce-captcha --tier strict`
  },
  {
    ...
    message: '2026-08-20 14:26:38 ERROR Database connection pool exhausted during peak tax return submission endpoint=/api/v3/tax/submit-annual-return source_ip=10.240.12.89',
    statusCode: 500,
...
govlog-cli db exec-query "REINDEX TABLE corporate_filings;"`
  },
  {
    ...
    message: '2026-08-20 14:26:35 INFO Authorized medical record query by National Hospital Central Node endpoint=/api/v1/patients/EHR-992014/summary source_ip=10.128.4.15',
    statusCode: 200,
  ...
  },
  {
    ...
    level: 'WARN',
    category: 'API Security',
    message: '2026-08-20 14:26:31 WARN Unusual bulk download request of property title GIS boundaries endpoint=/api/v2/cadastral/spatial-export source_ip=103.21.244.78',
    statusCode: 200,
...
govlog-cli audit alert --channel secops-slack --msg "Potential land data scraping detected"`
  },
  {
    ...
    message: '2026-08-20 14:26:28 CRITICAL Privilege escalation attempt on treasury disbursement approval endpoint=/api/v1/treasury/authorize-disbursement source_ip=45.154.255.89',
    statusCode: 401,
...
govlog-cli firewall block-ip 45.154.255.89`
  },
  {
    ...
    level: 'FATAL',
    category: 'Biometrics',
    message: '2026-08-20 14:26:24 FATAL Border node biometric matcher daemon lost connection to HSM key vault endpoint=/api/v2/biometrics/match-iris source_ip=10.250.0.12',
    statusCode: 503,
...
kubectl rollout restart deployment/biometric-matcher -n egov-border`
  },
  {
    ...
    message: '2026-08-20 14:26:19 INFO Batch citizen digital certificate renewal completed successfully endpoint=/api/v1/certs/cron-renew-batch source_ip=10.128.0.5',
    statusCode: 200,
