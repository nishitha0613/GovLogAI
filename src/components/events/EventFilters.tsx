...
export const EventFilters: React.FC<EventFiltersProps> = ({
  ...
  const categories = ['ALL', 'Authentication', 'API Security', 'Database Failure', 'Privilege Escalation', 'Unauthorized Access'];
  const statuses: (EventStatus | 'ALL')[] = ['ALL', 'Active', 'Investigating', 'Mitigated', 'Resolved'];
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-3">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            placeholder="Search security events by title, threat actor IP, or root cause..."
